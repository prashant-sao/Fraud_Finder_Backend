...
def create_app():
    ...
    allowed_origins = [
        "https://fraud-finder-frontend-ffw3.vercel.app",   # your real frontend
    ...
    def after_request(response):
        ...
        if origin in allowed_origins:   # allow only trusted domains
...
# Run database migrations + create default roles/user
...
# Local development run (Render will NOT use this)
